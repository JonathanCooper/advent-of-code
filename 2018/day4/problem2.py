...
if __name__ == '__main__':
    ...
    for k, v in guard_info.items():
        most_freq_min, count = v.most_freq_min()
        if count > max_minute_frequency:
            max_minute_frequency = count
            max_guard = k
            max_minute = most_freq_min
    print(f'max_guard * max_minute: {max_guard * max_minute}')
